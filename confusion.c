...
/*
 int CP[6][3] = {
    {1208, 1501, 1514}, // CP[0] x low // suunta 2
    {1802, 1487, 1505}, // CP[1] x high // suunta 4
    {1502, 1210, 1423}, // CP[2] y low // suunta 5
    {1523, 1774, 1618}, // CP[3] y high // suunta 6
    {1507, 1585, 1245}, // CP[4] z low // suunta 3
    {1508, 1392, 1806}, // CP[5] z high // suunta 1
};
*/
   ...
   **************************************/
    ...
    // Toistetaan 100 kertaa mittaus ja luokittelu
     for (int j = 0; j < 100; j++) {
        ...
        // Lasketaan etäisyydet kaikkiin keskipisteisiin ja valitaan lähin
        closestCP = -1;
        minDistance = INT_MAX;
